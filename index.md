...
#> <pointer: 0x5f94cffe8bf0>
tcc_data_ptr(ptr_ref)
#> <pointer: 0x5f94cf74fa20>
...
#> 1 Rtinycc      33.1ms   60.5ms      17.0   53.98KB     22.7
#> 2 Rbuiltin    564.3µs  612.5µs    1548.     9.05KB     28.0
...
#>   expression        min   median `itr/sec` mem_alloc `gc/sec`
#>   <bch:expr>   <bch:tm> <bch:tm>     <dbl> <bch:byt>    <dbl>
#> 1 Rtinycc_vec    20.2µs   20.6µs    44908.    39.1KB     31.5
#> 2 Rbuiltin_vec   16.9µs   17.6µs    56156.    78.2KB     78.7
```
...
.Internal(inspect(x))
#> @5f94d29ac548 13 INTSXP g0c0 [REF(65535)]  1 : 100 (compact)
...
.Internal(inspect(x))
#> @5f94d29ac548 13 INTSXP g0c0 [REF(65535)]  11 : 110 (expanded)
```
...
#>   expression      min   median `itr/sec` mem_alloc `gc/sec`
#>   <bch:expr> <bch:tm> <bch:tm>     <dbl> <bch:byt>    <dbl>
#> 1 R           602.1ms  602.1ms      1.66     847KB     4.98
#> 2 quickr       3.78ms   4.29ms    233.       782KB     4.10
#> 3 Rtinycc     57.39ms  59.75ms     16.9      782KB     0
...
#> <pointer: 0x5f94d42573e0>
ffi$struct_point_set_y(p1, 0.0)
#> <pointer: 0x5f94d42573e0>

p2 <- ffi$struct_point_new()
ffi$struct_point_set_x(p2, 3.0)
#> <pointer: 0x5f94cdeab220>
