...
main R thread executes the callback and returns the real value. At the
interactive console this happens automatically via R's event loop. In batch
contexts (including `rmarkdown::render`) you must start the worker without
blocking R, call `tcc_callback_async_drain()`, then join:
