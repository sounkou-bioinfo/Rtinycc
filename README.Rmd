...
These timed chunks are opt-in. Set `RTINYCC_RUN_BENCHMARKS=true` before
rendering the README if you want to execute them locally.

```{r ffi-overhead, eval = run_overhead_benchmarks}
rtinycc_code <- '
  #include <R.h>
  #include <Rinternals.h>
  #include <Rmath.h>
