...
The embedded htslib coroutine C source is extracted from the script and rendered
with the same Rtinycc C-code display helper used by the vignettes.

<details>
<summary>Click to show only the embedded C coroutine / htslib source</summary>
...
Rtinycc-based C coroutine layer for R.  Such a package could provide reusable
