...
Setter/getter helpers and functions that take struct pointers are exercised in the test suite (see [inst/tinytest/test_structs.R](inst/tinytest/test_structs.R) and [inst/tinytest/test_complex_types_clean.R](inst/tinytest/test_complex_types_clean.R)).
