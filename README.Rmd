...
The new FFI API provides a clean, declarative interface inspired by Bun's FFI. Define types explicitly and let TinyCC generate the binding code automatically.
...
**Note**: The `_Complex` workaround is automatically applied when using R headers.
