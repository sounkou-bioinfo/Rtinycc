...
#> <pointer: 0x6178effa20f0>
tcc_data_ptr(ptr_ref)
#> <pointer: 0x6178edd563a0>
...
#> 1 Rtinycc      28.9ms   28.9ms      34.6   53.98KB    553. 
#> 2 Rbuiltin    539.2µs  563.8µs    1755.     9.05KB     23.0
...
#>   expression        min   median `itr/sec` mem_alloc `gc/sec`
#>   <bch:expr>   <bch:tm> <bch:tm>     <dbl> <bch:byt>    <dbl>
#> 1 Rtinycc_vec    20.2µs   28.8µs    34263.    39.1KB     24.0
#> 2 Rbuiltin_vec     17µs   33.2µs    35536.    78.2KB     53.4
```
...
.Internal(inspect(x))
#> @6178f3b74590 13 INTSXP g0c0 [REF(65535)]  1 : 100 (compact)
...
.Internal(inspect(x))
#> @6178f3b74590 13 INTSXP g0c0 [REF(65535)]  11 : 110 (expanded)
```
...
#>   expression      min   median `itr/sec` mem_alloc `gc/sec`
#>   <bch:expr> <bch:tm> <bch:tm>     <dbl> <bch:byt>    <dbl>
#> 1 R          601.22ms 602.39ms      1.66     847KB    1.66 
#> 2 quickr       3.79ms   4.15ms    241.       782KB    4.11 
#> 3 Rtinycc     55.38ms  57.16ms     17.6      782KB    0.504
...
#> <pointer: 0x6178f3a5ad30>
ffi$struct_point_set_y(p1, 0.0)
#> <pointer: 0x6178f3a5ad30>

p2 <- ffi$struct_point_new()
ffi$struct_point_set_x(p2, 3.0)
#> <pointer: 0x6178f2af4220>
